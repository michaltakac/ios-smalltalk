...
class PharoBridge: ObservableObject {
    ...
    private static func wavesimScript() -> String {
        ...
        step
            ...
            self changed' classified: 'stepping'.
        ...
        drawOn: aCanvas
            ...
            WaveSimFFI wavesimRenderToDisplayX: self bounds left asInteger
                                        ...
                                        height: self bounds height asInteger' classified: 'drawing'.
        ...
        injectWaveAt: aPoint
            ...
            (gx between: 0 and: gridWidth) ifTrue: [
                (gy between: 0 and: gridHeight) ifTrue: [
        ...
        WaveSimMorph compile: '
        resetSimulation
            WaveSimFFI wavesimReset.
            self changed' classified: 'simulation'.

        WaveSimMorph compile: '
        speed ^ speed' classified: 'accessing'.
        WaveSimMorph compile: '
        damping ^ damping' classified: 'accessing'.
        WaveSimMorph compile: '
        colorScheme ^ colorScheme' classified: 'accessing'.
        WaveSimMorph compile: '
        normalScale ^ normalScale' classified: 'accessing'.
        WaveSimMorph compile: '
        sourceStrength ^ sourceStrength' classified: 'accessing'.
        WaveSimMorph compile: '
        sourceRadius ^ sourceRadius' classified: 'accessing'.
        WaveSimMorph compile: '
        stepsPerFrame ^ stepsPerFrame' classified: 'accessing'.

        "======== Window Launcher ========"

        WaveSimMorph class compile: '
        open
            ^ self openExtent: 800@700' classified: 'instance creation'.

        WaveSimMorph class compile: '
        openExtent: anExtent
            | window waveMorph canvasHeight |
            canvasHeight := (anExtent y * 0.85) asInteger.
            waveMorph := self new.
            waveMorph extent: anExtent x @ canvasHeight.
            ...
            window openInWorld.
            Stdio stderr nextPutAll: ''[wavesim] Window opened ''; nextPutAll: anExtent printString; lf; flush.
            ^ window' classified: 'instance creation'.

        Stdio stderr nextPutAll: '[wavesim] WaveSim classes loaded. Evaluate: WaveSimMorph open'; lf; flush.
        """
    }
